...
<div class="main-header">
    <div class="logo text-center">
        ...
        <i class="i-Shop-3 ml-2 " style="font-size: 24px"></i> پنل فروشگاه
    </div>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <div class="menu-icon-grid">
                    ...
                    <a href="{{url('/user/address')}}"><i class="i-Address-Book"></i>فروشگاه</a>
                    <a href="{{url('/user/wallet')}}"><i class="i-Wallet-21"></i>سفارشات</a>
                    <a href="{{url('/user/order')}}"><i class="i-Checkout"></i> محصولات</a>
                    <a href="{{'/user/favourite'}}"><i class="i-Tag-3"></i>نظرات</a>
