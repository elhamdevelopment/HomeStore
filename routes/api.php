...
Route::post('/user/getWalletTransaction','user\WalletController@getWalletTransaction');
Route::post('/user/add-address','user\AddressController@addAddress');
Route::post('/user/update-address','user\AddressController@updateAddress');
...
Route::post('/user/getAddressById','user\AddressController@getAddressById');
...
Route::post('/user/get-order','user\OrderController@getOrders');
Route::post('/user/addSupport','user\SupportController@addSupport');
